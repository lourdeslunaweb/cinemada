                ...
                {users?.map((user, index) => {
                    return (
                        <div key={index} className="card border-info m-3" style={{ maxWidth: '20rem' }}>
                            ...
                            <button type="button" className="btn btn-info" onClick={() => handleDeleteUser(user.id)}><svg xmlns="http://www.w3.org/2000/svg" width={16} height={16} fill="currentColor" className="bi bi-trash" viewBox="0 0 16 16">
